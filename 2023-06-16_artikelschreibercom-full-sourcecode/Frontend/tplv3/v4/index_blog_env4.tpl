...
<html lang="{language}" itemscope itemtype="https://schema.org/Article">
	<head>
		...
		<link rel="preload" href="https://www.artikelschreiber.com/css/video-js.css" as="style" />
		<link rel="preload" href="https://www.artikelschreiber.com/js/video/video.min.js" as="script" />
		<link rel="preload" href="https://www.artikelschreiber.com/js/video/youtube.min.js" as="script" />
		<title>{title}</title>
		<meta charset="UTF-8" />
		...
		<link href="https://www.artikelschreiber.com/css/video-js.css" rel="stylesheet" />
	...
	<body itemscope itemtype="https://schema.org/WebPage" style="text-align: left; overflow-wrap: break-word; word-wrap: normal; word-break: break-word;" translate="yes" lang="{language}">
			...
			<header>
				<nav class="nav" tabindex="-1" role="navigation" onclick="this.focus()" aria-label="Navigation">
					<div class="container">
						<a class="pagename current" href="{startpage_url_en}" target="_self" hreflang="en" title="{index_description_en}"><img src="{startpage_url_de}images/flags/en.png" width="32" height="32" alt="English Flag" title="{index_description_en}" />{index_title_short_en}</a>
						<a href="{startpage_url_de}" target="_self" hreflang="de" title="{index_description_de}" ><img src="{startpage_url_de}images/flags/de.png" width="32" height="32" alt="Deutsche Flagge" title="{index_description_de}" />{index_title_short_de}</a>
						...
						<a hreflang="en" href="https://www.unaique.net/en/" title="AI Text Generator for Content Marketing | UNAIQUE.NET"><img src="{startpage_url_de}images/flags/en.png" width="32" height="32" alt="AI Text Generator" />AI Text Generator</a>
					</div>
				</nav>
			</header>
			...
			<div class="hero">
				<fieldset lang="{language}">
					<form action="https://www.artikelschreiber.com/textgenerator.php" method="POST" id="kontakt_form" autocomplete="on">
						<input type="hidden" name="lang" maxlength="2" size="2" value="en" aria-required>
						<h1 role="heading" aria-level="1"><strong><b>{startpage_header_h1}</b></strong></h1>
							<div class="row">
								<div class="col c4" title="Please enter here a few keywords or a sentence on the topic for which you want the ghost writer ArtikelSchreiber.com to write your text">
									<label for="mainkeyword"><span class="green_bold">Step 1</span>: Topic of your Article</label><br />
									<input type="search" id="mainkeyword" name="mainkeyword" maxlength="150" size="21" placeholder="Enter your main keywords!" oninvalid="this.setCustomValidity('Enter your main keywords (topic of the article):')" oninput="this.setCustomValidity('')" aria-required autofocus spellcheck="true" />
								</div>
								<div class="col c4" title="Please enter here a few keywords or a sentence about the focus of the content for which you want the ghost writer ArtikelSchreiber.com to write your text">
									<label for="subkeyword"><span class="green_bold">Step 2</span>: Focus of your Text</label><br />
									<input type="search" id="subkeyword" name="subkeyword" maxlength="150" size="21" placeholder="Enter your sub keywords!" oninvalid="this.setCustomValidity('Enter your sub keywords (nuance of the text):')" oninput="this.setCustomValidity('')" spellcheck="true" />
								</div>
								<div class="col c4" title="Click the green button with the white text 'Create text!' to start writing your paper automatically">
									<label for="button"><span class="green_bold">Step 3</span>: Click "Create text!"</label><br />
									<input type="submit" id="button" role="button" class="btn btn-b" value="Create text!" style="font-size:16px;font-weight: bold;" id="mySubmitButtonCreateText" title="Click here to let ArtikelSchreiber.com write your unique article!" />
								</div>
							</div>
					</form>
		...
		<fieldset lang="{language}">
			...
			<a name="NachObenScrollen"></a>
			<nav role="navigation">
				<p><em><strong>Highlights of your article:</strong></em></p>	
				<ul role="list">
					<li role="listitem" id="a"><a href="#DownloadArticle" title="Download the written article"><span>Download the article</span></a></li>
					<li role="listitem" id="x"><a href="#Title" title="Title of your written Article"><span>Headline</span></a></li>
					<li role="listitem" id="b"><a href="#Summary" title="Summary of the written article"><span>Summary</span></a></li>
					<li role="listitem" id="y"><a href="#AI_generated_content_by_ChatGPT_GPT4_and_GPT3" title="AI generated content by ChatGPT, GPT-4 and GPT-3"><span>Your free Article Text</span></a></li>
					<li role="listitem" id="o"><a href="#YoutubeVideo" title="The matching Youtube video for your article"><span>Your Youtube Video</span></a></li>
					<li role="listitem" id="k"><a href="#SocialMediaTags" title="Social Media Tags"><span>Social Media Tags</span></a></li>
					<li role="listitem" id="l"><a href="#ExternalLinks" title="Content related external links"><span>External Links</span></a></li>
					<li role="listitem" id="m"><a href="#CreateSimilarArticles" title="Create thematically similar articles texts"><span>Create more Texts</span></a></li>
					<li role="listitem" id="n"><a href="#FAQ" title="We can answer the following questions in this text"><span>Questions & Answers</span></a></li>
					<li role="listitem"><a href="#SocialShareButtons" title="Share this article with your friends"><span>Share your Article</span></a></li>
					<li role="listitem"><a href="#Author" title="Angaben zum Autor"><span>Author</span></a></li>
				</ul>
			</nav>
		</fieldset>
		...
		<fieldset lang="{language}" role="main">
			<legend><b>Completion of your individual article</b></legend>

			<p id="DownloadArticle"><b><u>Download Article:</u></b> &nbsp;&nbsp;&nbsp;<span><a onclick="this.href='data:text/plain;charset=UTF-8,'+encodeURIComponent(document.documentElement.outerHTML)" href="#" download="article_from_artikelschreiber.com.html">Download as HTML File</a></span></p>

			<p><hr /></p>
			
			<p><strong><span id="Title"><h1 role="heading" aria-level="1">{title}</h1></span></strong></p>
						
			<p><span>{description}</span></p>
			
			<p><hr /></p>
			
			<p id="Summary"><b><u>Summary:</u></b> &nbsp;&nbsp;&nbsp;<span>{summary}</span></p>
			
			<p><hr /></p>
			
			<p></p>
			<span id="AI_generated_content_by_ChatGPT_GPT4_and_GPT3">
				<p>{ai_adv}</p>
			</span>
			
			<p><hr /></p>
			
			<p><span id="YoutubeVideo"><b><u>Youtube Video</u></b></span></p>
				<video
					id="vid1"
					...
					data-setup='{ "techOrder": ["youtube"], "sources": [{ "type": "video/youtube", "src": "{youtube_video}"}],"youtube": { "controls": 1, "hl":"{language}","modestbranding":1, "rel":1, "ytControls": 2, "customVars": { "wmode": "transparent" }} }'
				  >
				</video>
				<br /><span>Video description: {youtube_title}</span></p>
			</span></p>
			
			<p><hr /></p>
						
			<p><span>{image_code}</span><br /><span>Image description: {description}</span></p>
			...
			<p><b><u id="ExternalLinks">Content related links:</u></b> 
			&nbsp;&nbsp;&nbsp;<span>{external_links}</span>
			
			&nbsp;&nbsp;&nbsp;<span>{additionalNewsLinks}</span>
			</p>
						
			<p><hr /></p>
									
			<p><b><u id="CreateSimilarArticles">Create more Texts:</u></b> &nbsp;&nbsp;&nbsp; <span>{suggestions}</span></p>
			
			<p><hr /></p>
			
			<p><b><u id="FAQ">We can answer the following questions in this text:</u></b></p>
			{schemaorg_faq}
			{schemaorg_faq_html}
			...
			<p><b><u id="Author">Author:</u></b> &nbsp;&nbsp;&nbsp; <span role="contentinfo">{author}</span></p>
		...
		<fieldset lang="{language}">
			<legend><label for="myInput"><b>Please link to us on high quality websites:</b></label></legend>
			...
			<div class="tooltip">
			<p>
				<button onclick="myFunction();" onmouseout="outFunc()" title="Click here to copy the text to the clipboard!">	<span class="tooltiptext" id="myTooltip">Copied to clipboard</span>copy text</button>
			</p>	
			</div>
		</fieldset>
		...
		<fieldset lang="{language}">
			<legend><i class="ico">✉</i> Subscribe to the <b><em> free of charge</em> ArtikelSchreiber Newsletter</b>! <i class="ico">✉</i></legend>
			<br />
			<b>More advertising revenue per month? Independent business? Get Financially independent? Find out how! </b>
			<br /><br />
			Register with your business email address and learn how:
			
				<p>
				<label for="firstname">Your first name:</label>
					&nbsp;&nbsp;&nbsp;<input type="text" id="firstname" name="firstname" autocomplete="given-name" size="17" maxlength="140" minlength="1" placeholder="first name" />
				</p>
				<p>
				<label for="lastname">Your last name:</label>
					<input type="text" id="lastname" name="lastname" autocomplete="family-name" size="17" maxlength="140" minlength="1" placeholder="last name" />
				</p>
				<p>
				...
				<input type="submit" id="submit" class="btn btn-b" value="Free Sign Up" style="font-size:16px;font-weight: bold;" /> 
				</p>
		...
		<section>
			<footer class="footer">
				<p>
					&copy; 2016 - 2023 - <strong>ArtikelSchreiber.com: ✅ Marketing: Write an article, free text or marketing content with SEO tool for ✅ eCommerce, Business, Sales and Upsell with ✅ Text generator based on ✅ Artificial General Intelligence (AGI) / AI and ✅ Natural Language Processing/NLP</strong>
				</p>
				<p>
...
<script type="text/javascript" async>
  ...
  var attentionMessage = 'Please come back to us!';
...
<script src="https://www.artikelschreiber.com/js/video/video.min.js"></script>
<script src="https://www.artikelschreiber.com/js/video/youtube.min.js"></script>
