...
<html lang="{language}" itemscope itemtype="https://schema.org/Article">
	...
	<body itemscope itemtype="https://schema.org/WebPage" style="text-align: left; overflow-wrap: break-word; word-wrap: normal; word-break: break-word;" translate="yes" lang="{language}">
		...
		<fieldset lang="{language}">
			...
			<nav role="navigation">
				...
				<ul role="list">
					...
					<li role="listitem" id="x"><a href="#Titel" title="Titel des geschriebenen Artikels"><span>Überschrift</span></a></a></li>
					...
					<li role="listitem" id="y"><a href="#KI_generierter_Inhalt_durch_ChatGPT_GPT4_und_GPT3" title="KI generierter Inhalt (Support durch ChatGPT, GPT-4, GPT-3)"><span>Dein Artikel Text</span></a></li>
					<li role="listitem" id="o"><a href="#YoutubeVideo" title="Das passendes Youtube Video zu deinem Artikel"><span>Dein Youtube Video</span></a></li>
					...
					<li role="listitem" id="m"><a href="#CreateSimilarArticles" title="Erstelle thematisch ähnliche Artikel Texte"><span>Erstelle weitere Texte</span></a></li>
					<li role="listitem" id="n"><a href="#FAQ" title="Folgende Fragen können wir dir in diesem Text beantworten"><span>Fragen und Antworten</span></a></li>
					<li role="listitem"><a href="#SocialShareButtons" title="Share this article with your friends"><span>Teile deinen Artikel</span></a></li>
					<li role="listitem"><a href="#Autor" title="Angaben zum Autor"><span>Autor</span></a></li>
				</ul>
			</nav>
		</fieldset>
		...
		<fieldset lang="{language}" role="main">
			...
			<p><strong><span id="Titel"><h1 role="heading" aria-level="1">{title}</h1></span></strong></p>
			...
			<p></p>
			<span id="KI_generierter_Inhalt_durch_ChatGPT_GPT4_und_GPT3">
				<p>{ai_adv}</p>
			</span>
			...
			<p><span id="YoutubeVideo"><b><u>Youtube Video</u></b></span></p>
				...
				<br /><span>Videobeschreibung: {youtube_title}</span></p>
			</span></p>
			...
			<p><b><u id="ExternalLinks">Inhaltsbezogene Links:</u></b> 
			...
			<p><b><u id="FAQ">Folgende Fragen können wir dir beantworten:</u></b></p>
			{schemaorg_faq}
			{schemaorg_faq_html}
			...
			<p><b><u id="Autor">Autor:</u></b> &nbsp;&nbsp;&nbsp; <span role="contentinfo">{author}</span></p>
