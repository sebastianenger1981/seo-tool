...
<html lang="{language}" itemscope itemtype="https://schema.org/Article">
	<head>
		...
		<meta property="og:url" content="{startpage_url_en}" />
		...
		<meta property="article:publisher" content="{startpage_url_en}" />
		...
		<meta name="twitter:url" content="{startpage_url_en}" />
		...
		<link rel="alternate" href="{startpage_url_en}texts/feed.php" title="RSS feed | ArtikelSchreiber.com" type="application/rss+xml" />
	...
	<body itemscope itemtype="https://schema.org/WebPage" style="text-align: left; overflow-wrap: break-word; word-wrap: normal; word-break: break-word;" translate="yes" lang="{language}">
		...
		<fieldset lang="{language}">
			...
			<nav role="navigation">
				...
				<ul role="list">
					...
					<li role="listitem" id="y"><a href="#AI_generated_content_by_ChatGPT_GPT4_and_GPT3" title="AI generated content by ChatGPT, GPT-4 and GPT-3"><span>Article written by ChatGPT, GPT-4 & GPT-3</span></a></li>
					<ul role="list">
					...
					<li role="listitem" id="i"><a href="#FullArticle" title="The complete article written with AI"><span>Your created article</span></a></li>
					<li role="listitem" id="j"><a href="#ReadingTime" title="Reading time information"><span>Reading Time</span></a></li>
		...
		<fieldset lang="{language}" role="main">
			...
			<p><span id="AI_generated_content_by_ChatGPT_GPT4_and_GPT3">{ai_adv}</span></p>
			...
			<p><b><u id="ReadingTime">Reading Time:</u></b> &nbsp;&nbsp;&nbsp; <span>{reading_time}</span></p>
			...
			<p><b><u id="ExternalLinks">Content related external links:</u></b> &nbsp;&nbsp;&nbsp;<span>{external_links}</span></p>
			...
			<p><b><u>Source:</u></b> &nbsp;&nbsp;&nbsp; <span><a href="{article_source}" target="_blank" rel="nofollow">{article_source_description}</a></span></p>
