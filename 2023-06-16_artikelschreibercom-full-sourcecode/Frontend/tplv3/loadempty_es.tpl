...
<html lang="es">
	<head>
		...
		<meta name="keywords" content="redacción, generador de textos, artículos, textos, escritura creativa, creación de artículos, redactor de artículos, creador de contenidos, creación de contenidos, narración de historias, artículos gratuitos, texto único, contenido único, redactor de artículos, redacción de textos, autor, periodismo, periodista, redactor, editor, medios de comunicación, periódico, artículo periodístico, publicación, redacción de artículos, redacción de textos, redacción de textos" />
		...
		<meta name="twitter:url" content="https://www.artikelschreiber.com/es/" />
	...
	<body style="text-align:center; overflow-wrap: break-word; word-wrap: normal; word-break: break-word;" translate="yes" lang="es">
		<div class="container">
			<h4 id="showBanner">
				<fieldset lang="es">
					...
					<div class="tooltip">
					<button onclick="myFunction();" onmouseout="outFunc()" title="Haga clic aquí para copiar el texto en el portapapeles.">
					  <span class="tooltiptext" id="myTooltip">Copiado en el portapapeles</span>
					 Copiar texto
					  </button>
					</div>
					
					<p>
						<b><u id="SocialShareButtons">Compartir texto con amigos:</u></b> &nbsp;&nbsp;&nbsp;
				...
				<br />
				<fieldset lang="es">
					<legend><b>Información de estado:</b></legend>
					<p>
						<ul>
							<li>Por favor, mantén esta página web o pestaña abierta - lo comprobaré regularmente para ver si tu artículo ha sido completado. </li>
							<li>Si es así, te lo enseño, si no, lo vuelvo a intentar unos segundos después. </li>
							<li>Por favor, espere - se necesita algo de tiempo para terminar su artículo individual (¡vale la pena!).</li>
							<li>El servicio está actualmente muy ocupado. Es posible que su artículo tarde más de lo normal en completarse.</li>
							<li>Una vez terminado su artículo único, puede descargarlo como archivo de texto de forma gratuita.</li>
						</ul>
					</p>
				</fieldset>
			</h4>
			<br />
			<fieldset lang="es">
				<legend><b>Progreso en la creación de su artículo:</b></legend>
			...
			for(i=0; i<=35000; i++) {
				setTimeout(function() { 
					...
					$('.loading span').html(num+'%');
				   	num++;
					if(num>=99){
						$('#statusMessage').html("<br /><br /><br /><b>Realice el paso 5: Recoja su artículo.</b>").show();
					} else if(num>=55){
						$('#statusMessage').html("<br /><br /><br /><b>Realice el paso 4: Cree su propio texto.</b>").show();
					} else if(num>=20){
						$('#statusMessage').html("<br /><br /><br /><b>Realice el paso 3: Utilice herramientas de Procesamiento del Lenguaje Natural para preprocesar todos los recursos encontrados.</b>").show();
					} else if(num>=10){
						$('#statusMessage').html("<br /><br /><br /><b>Realice el paso 2: Utilice las fuentes de contenido.</b>").show();
					}else if(num>=1){
						$('#statusMessage').html("<br /><br /><br /><b>Realice el paso 1: Evalúe sus palabras clave.</b>").show();
					}
				},30000);
			};
		}
...
function myFunction() {
  ...
  tooltip.innerHTML = "¡Copiado con éxito!";
}

function outFunc() {
  var tooltip = document.getElementById("myTooltip");
  tooltip.innerHTML = "Copiado en el portapapeles";
}
</script>

<script async>
document.getElementById("shareFacebook").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u='+'https://www.artikelschreiber.com/es/'+'">Facebook</a>';
document.getElementById("shareTwitter").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://twitter.com/share?url='+'https://www.artikelschreiber.com/es/'+'">Twitter</a>';
document.getElementById("shareWhatsApp").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="whatsapp://send?text='+'https://www.artikelschreiber.com/es/'+'">WhatsApp</a>';
document.getElementById("shareLinkedIn").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&url='+'https://www.artikelschreiber.com/es/'+'">LinkedIn</a>';
document.getElementById("shareEmail").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="mailto:?subject=Check out the free ArtikelSchreiber.com&body='+'https://www.artikelschreiber.com/es/'+'">eMail</a>';
document.getElementById("sharevKontakte").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://vkontakte.ru/share.php?url='+'https://www.artikelschreiber.com/es/'+'">vKontakte</a>';
document.getElementById("shareTumblr").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://www.tumblr.com/share/link?url='+'https://www.artikelschreiber.com/es/'+'">Tumblr</a>';
document.getElementById("shareLineit").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://lineit.line.me/share/ui?url='+'https://www.artikelschreiber.com/es/'+'">LineIT</a>';
document.getElementById("shareSkype").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://web.skype.com/share?url='+'https://www.artikelschreiber.com/es/'+'">Skype</a>';
document.getElementById("shareTelegram").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://telegram.me/share/url?url='+'https://www.artikelschreiber.com/es/'+'">Telegram</a>';
document.getElementById("shareSnapChat").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://snapchat.com/scan?attachmentUrl='+'https://www.artikelschreiber.com/es/'+'">SnapChat</a>';
document.getElementById("shareReddit").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://reddit.com/submit?url='+'https://www.artikelschreiber.com/es/'+'">Reddit</a>';
document.getElementById("shareFlipboard").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://share.flipboard.com/bookmarklet/popout?url='+'https://www.artikelschreiber.com/es/'+'">Flipboard</a>';
document.getElementById("shareXing").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://www.xing.com/spi/shares/new?url='+'https://www.artikelschreiber.com/es/'+'">XING</a>';
</script>
