...
<html lang="it">
	<head>
		...
		<meta name="keywords" content="scrittura, generatore di testo, articoli, testi, scrittura creativa, creazione di articoli, scrittore di articoli, creatore di contenuti, creazione di contenuti, narrazione, articoli gratuiti, testo unico, contenuto unico, scrittore di articoli, copywriting, copywriter, autore, giornalismo, giornalista, editore, redattore, media, giornale, articolo di giornale, pubblicazione, scrittura di articoli, scrittura di testi, scrivere testi" />
		...
		<meta property="og:url" content="https://www.artikelschreiber.com/it/" />
		...
		<meta name="twitter:url" content="https://www.artikelschreiber.com/it/" />
		<meta name="twitter:image" content="https://www.artikelschreiber.com/images/apple-icon-200x200.png" />
		
		<link rel="icon" type="image/png" sizes="32x32" href="/images/favicon-32x32.png" />	
		<link rel="canonical" href="https://www.artikelschreiber.com/it/" />
	...
	<body style="text-align:center; overflow-wrap: break-word; word-wrap: normal; word-break: break-word;" translate="yes" lang="it">
		<div class="container">
			<h4 id="showBanner">
				<fieldset lang="it">
					...
					<div class="tooltip">
					<button onclick="myFunction();" onmouseout="outFunc()" title="Clicca qui per copiare il testo negli appunti!">
					  <span class="tooltiptext" id="myTooltip">Copiato negli appunti</span>
					 Copiare il testo
					  </button>
					</div>	
					
					<p>
						<b><u id="SocialShareButtons">Condividi il testo con gli amici:</u></b> &nbsp;&nbsp;&nbsp;
				...
				<br />
				<fieldset lang="it">
					<legend><b>Informazioni di stato:</b></legend>
					<p>
						<ul>
							<li>Per favore, tieni aperta questa pagina web o scheda - controllerò regolarmente per vedere se il tuo articolo è stato completato. </li>
							<li>Per favore aspettate - ci vuole un po' di tempo per finire il vostro articolo individuale (ne vale la pena!!!).</li>
							<li>Il servizio è attualmente molto occupato. Il completamento del tuo articolo potrebbe richiedere più tempo del normale.</li>
							<li>Dopo che il tuo articolo unico è finito, puoi scaricarlo come file di testo gratuitamente.</li>
						</ul>
					</p>
				</fieldset>
			</h4>
			<br />
			<fieldset lang="it">
				<legend><b>Progressi nella creazione del tuo articolo:</b></legend>
			...
			for(i=0; i<=35000; i++) {
				setTimeout(function() { 
					...
					$('.loading span').html(num+'%');
				   	num++;
					if(num>=99){
						$('#statusMessage').html("<br /><br /><br /><b>Eseguire il passo 5: Ritira il tuo articolo!</b>").show();
					} else if(num>=55){
						$('#statusMessage').html("<br /><br /><br /><b>Eseguire il passo 4: Crea il tuo testo individuale!</b>").show();
					} else if(num>=20){
						$('#statusMessage').html("<br /><br /><br /><b>Eseguire il passo 3: Usa gli strumenti di Natural Language Processing per pre-elaborare tutte le risorse trovate!</b>").show();
					} else if(num>=10){
						$('#statusMessage').html("<br /><br /><br /><b>Eseguire il passo 2: Usa le fonti di contenuto!</b>").show();
					}else if(num>=1){
						$('#statusMessage').html("<br /><br /><br /><b>Eseguire il passo 1: Valutate le vostre parole chiave!</b>").show();
					}
				},30000);
			};
		}
...
function myFunction() {
  ...
  tooltip.innerHTML = "Copiato con successo!";// + copyText.value;
}

function outFunc() {
  var tooltip = document.getElementById("myTooltip");
  tooltip.innerHTML = "Copiato negli appunti";
}
</script>

<script async>
document.getElementById("shareFacebook").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u='+'https://www.artikelschreiber.com/it/'+'">Facebook</a>';
document.getElementById("shareTwitter").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://twitter.com/share?url='+'https://www.artikelschreiber.com/it/'+'">Twitter</a>';
document.getElementById("shareWhatsApp").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="whatsapp://send?text='+'https://www.artikelschreiber.com/it/'+'">WhatsApp</a>';
document.getElementById("shareLinkedIn").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&url='+'https://www.artikelschreiber.com/it/'+'">LinkedIn</a>';
document.getElementById("shareEmail").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="mailto:?subject=Check out the free ArtikelSchreiber.com&body='+'https://www.artikelschreiber.com/it/'+'">eMail</a>';
document.getElementById("sharevKontakte").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://vkontakte.ru/share.php?url='+'https://www.artikelschreiber.com/it/'+'">vKontakte</a>';
document.getElementById("shareTumblr").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://www.tumblr.com/share/link?url='+'https://www.artikelschreiber.com/it/'+'">Tumblr</a>';
document.getElementById("shareLineit").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://lineit.line.me/share/ui?url='+'https://www.artikelschreiber.com/it/'+'">LineIT</a>';
document.getElementById("shareSkype").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://web.skype.com/share?url='+'https://www.artikelschreiber.com/it/'+'">Skype</a>';
document.getElementById("shareTelegram").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://telegram.me/share/url?url='+'https://www.artikelschreiber.com/it/'+'">Telegram</a>';
document.getElementById("shareSnapChat").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://snapchat.com/scan?attachmentUrl='+'https://www.artikelschreiber.com/it/'+'">SnapChat</a>';
document.getElementById("shareReddit").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://reddit.com/submit?url='+'https://www.artikelschreiber.com/it/'+'">Reddit</a>';
document.getElementById("shareFlipboard").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://share.flipboard.com/bookmarklet/popout?url='+'https://www.artikelschreiber.com/it/'+'">Flipboard</a>';
document.getElementById("shareXing").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://www.xing.com/spi/shares/new?url='+'https://www.artikelschreiber.com/it/'+'">XING</a>';
</script>
