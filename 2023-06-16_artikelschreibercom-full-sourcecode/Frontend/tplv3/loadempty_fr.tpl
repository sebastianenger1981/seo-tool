...
<html lang="fr">
	<head>
		...
		<meta name="keywords" content="écriture, générateur de texte, articles, textes, écriture créative, création d'article, rédacteur d'article, créateur de contenu, création de contenu, narration, articles gratuits, texte unique, contenu unique, rédacteur d'article, copywriting, rédacteur, auteur, journalisme, journaliste, rédacteur, éditeur, média, journal, article de journal, publication, écriture d'article, écriture de texte, écriture de textes" />
		...
		<meta property="og:url" content="https://www.artikelschreiber.com/fr/" />
		...
		<meta name="twitter:url" content="https://www.artikelschreiber.com/fr/" />
		<meta name="twitter:image" content="https://www.artikelschreiber.com/images/apple-icon-200x200.png" />
		
		<link rel="icon" type="image/png" sizes="32x32" href="/images/favicon-32x32.png" />
		<link rel="canonical" href="https://www.artikelschreiber.com/fr/" />
	...
	<body style="text-align: center; overflow-wrap: break-word; word-wrap: normal; word-break: break-word;" translate="yes" lang="fr">
		<div class="container">
			<h4 id="showBanner">
				<fieldset lang="fr">
					...
					<div class="tooltip">
					<button onclick="myFunction();" onmouseout="outFunc()" title="Cliquez ici pour copier le texte dans le presse-papiers!">
					  <span class="tooltiptext" id="myTooltip">Copié dans le presse-papiers</span>
					  Copier le texte
					  </button>
					</div>
					
					<p>
						<b><u id="SocialShareButtons">Partager un texte avec des amis:</u></b> &nbsp;&nbsp;&nbsp;
				...
				<br />
				<fieldset lang="fr">
					<legend><b>Informations sur le statut:</b></legend>
					<p>
						<ul>
							<li>Merci de laisser cette page web ou cet onglet ouvert - je vérifie régulièrement si ton article est terminé. </li>
							<li>Si c'est le cas, je te l'affiche, sinon, je réessaie quelques secondes plus tard. </li>
							<li>S'il te plaît, attends - il faut un peu de temps pour que ton article individuel soit terminé (cela en vaut la peine !!!).</li>
							<li>Le service est actuellement très sollicité. Cela peut prendre plus de temps que d'habitude pour que ton article soit terminé.</li>
							<li>Une fois que ton article unique est rédigé, tu peux le télécharger gratuitement sous forme de fichier texte.</li>
						</ul>
					</p>
				</fieldset>		
			</h4>
			<br />
			<fieldset lang="fr">
				<legend><b>Progression dans la création de votre article:</b></legend>
			...
			for(i=0; i<=35000; i++) {
				setTimeout(function() { 
					...
					$('.loading span').html(num+'%');
				   	num++;
					if(num>=99){
						$('#statusMessage').html("<br /><br /><br /><b>Effectuez l'étape 5 : obtenez votre article !</b>").show();
					} else if(num>=55){
						$('#statusMessage').html("<br /><br /><br /><b>Étape 4 : Créez votre propre texte !</b>").show();
					} else if(num>=20){
						$('#statusMessage').html("<br /><br /><br /><b>Étape 3 : Utilisez les outils de traitement du langage naturel pour prétraiter toutes les ressources trouvées !</b>").show();
					} else if(num>=10){
						$('#statusMessage').html("<br /><br /><br /><b>Effectuer l'étape 2 : créer des sources de contenu !</b>").show();
					}else if(num>=1){
						$('#statusMessage').html("<br /><br /><br /><b>Première étape : évaluez vos mots-clés !</b>").show();
					}
				},30000);
			};
		}
...
function myFunction() {
  ...
  tooltip.innerHTML = "Copié avec succès !";
}

function outFunc() {
  var tooltip = document.getElementById("myTooltip");
  tooltip.innerHTML = "Copié dans le presse-papiers";
}
</script>

<script async>
document.getElementById("shareFacebook").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u='+'https://www.artikelschreiber.com/fr/'+'">Facebook</a>';
document.getElementById("shareTwitter").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://twitter.com/share?url='+'https://www.artikelschreiber.com/fr/'+'">Twitter</a>';
document.getElementById("shareWhatsApp").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="whatsapp://send?text='+'https://www.artikelschreiber.com/fr/'+'">WhatsApp</a>';
document.getElementById("shareLinkedIn").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&url='+'https://www.artikelschreiber.com/fr/'+'">LinkedIn</a>';
document.getElementById("shareEmail").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="mailto:?subject=Check out the free ArtikelSchreiber.com&body='+'https://www.artikelschreiber.com/fr/'+'">eMail</a>';
document.getElementById("sharevKontakte").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://vkontakte.ru/share.php?url='+'https://www.artikelschreiber.com/fr/'+'">vKontakte</a>';
document.getElementById("shareTumblr").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://www.tumblr.com/share/link?url='+'https://www.artikelschreiber.com/fr/'+'">Tumblr</a>';
document.getElementById("shareLineit").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://lineit.line.me/share/ui?url='+'https://www.artikelschreiber.com/fr/'+'">LineIT</a>';
document.getElementById("shareSkype").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://web.skype.com/share?url='+'https://www.artikelschreiber.com/fr/'+'">Skype</a>';
document.getElementById("shareTelegram").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://telegram.me/share/url?url='+'https://www.artikelschreiber.com/fr/'+'">Telegram</a>';
document.getElementById("shareSnapChat").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://snapchat.com/scan?attachmentUrl='+'https://www.artikelschreiber.com/fr/'+'">SnapChat</a>';
document.getElementById("shareReddit").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://reddit.com/submit?url='+'https://www.artikelschreiber.com/fr/'+'">Reddit</a>';
document.getElementById("shareFlipboard").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://share.flipboard.com/bookmarklet/popout?url='+'https://www.artikelschreiber.com/fr/'+'">Flipboard</a>';
document.getElementById("shareXing").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://www.xing.com/spi/shares/new?url='+'https://www.artikelschreiber.com/fr/'+'">XING</a>';
</script>
