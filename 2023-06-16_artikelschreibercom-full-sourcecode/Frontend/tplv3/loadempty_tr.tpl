...
<html lang="tr">
	<head>
		...
		<meta name="keywords" content="yazmak, metin oluşturucu, makale, metinler, yaratıcı yazarlık, makale oluştur, makale yazarı, içerik oluşturucu, içerik oluşturma, hikaye anlatımı, ücretsiz makale, benzersiz metin, benzersiz içerik, makale yazarı, metin yazarlığı, metin yazarı, yazar, gazetecilik, gazeteci, editör, Medya, Gazete, Gazete Makalesi, Yayın, Makale Yaz, Metin Yaz, Metin Yaz" />
		...
		<link rel="icon" type="image/png" sizes="32x32" href="https://www.artikelschreiber.com/images/apple-icon-200x200.png" />
		
		<link rel="alternate" hreflang="tr" href="https://www.artikelschreiber.com/" />
	...
	<body style="text-align:center; overflow-wrap: break-word; word-wrap: normal; word-break: break-word;" translate="yes" lang="tr">
		<div class="container">
			<h4 id="showBanner">
				<fieldset lang="tr">
					...
					<p>
						<b><u id="SocialShareButtons">Arkadaşlarınızla metin paylaşın:</u></b> &nbsp;&nbsp;&nbsp;
				...
				<br />
				<fieldset lang="tr">
					<legend><b>durum bilgisi:</b></legend>
					<p>
						<ul>
							<li>Lütfen bu web sayfasını veya sekmeyi açık bırakın - Makalenizin tamamlanıp tamamlanmadığını düzenli olarak kontrol edeceğim.</li>
							<li>Eğer öyleyse, size göstereceğim, değilse birkaç saniye sonra tekrar deneyeceğim.</li>
							<li>Lütfen bekleyin - özel öğenizi tamamlamanız biraz zaman alacak (buna değer!!!).</li>
							<li>Servis şu anda çok meşgul. Öğenizin tamamlanması normalden daha uzun sürebilir.</li>
							<li>Özgün makaleniz yazıldıktan sonra metin dosyası olarak ücretsiz olarak indirebilirsiniz.</li>
						</ul>
					</p>
				</fieldset>
			</h4>
			<br />
			<fieldset lang="tr">
				<legend><b>Makalenizi oluşturmada ilerleme:</b></legend>
			...
			for(i=0; i<=35000; i++) {
				setTimeout(function() { 
					...
					$('.loading span').html(num+'%');
				   	num++;
					if(num>=99){
						$('#statusMessage').html("<br /><br /><br /><b>5. adımı: uygulayın: Öğenizi alın!</b>").show();
					} else if(num>=55){
						$('#statusMessage').html("<br /><br /><br /><b>4. adımı gerçekleştirin: Kişisel metninizi oluşturun!</b>").show();
					} else if(num>=20){
						$('#statusMessage').html("<br /><br /><br /><b>3. adımı: Bulunan tüm kaynakları önceden işlemek için doğal dil işleme araçlarını kullanın!</b>").show();
					} else if(num>=10){
						$('#statusMessage').html("<br /><br /><br /><b>2. adımı gerçekleştirin: İçerik kaynaklarını kullanın!</b>").show();
					}else if(num>=1){
						$('#statusMessage').html("<br /><br /><br /><b>1. adımı gerçekleştirin: Anahtar kelimelerinizi değerlendirin!</b>").show();
					}
				},30000);
			};
		}
...
function myFunction() {
  ...
  tooltip.innerHTML = "Başarıyla kopyalandı!";
}
...
<script async>
document.getElementById("shareFacebook").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u='+'https://www.artikelschreiber.com/tr/'+'">Facebook</a>';
document.getElementById("shareTwitter").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://twitter.com/share?url='+'https://www.artikelschreiber.com/tr/'+'">Twitter</a>';
document.getElementById("shareWhatsApp").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="whatsapp://send?text='+'https://www.artikelschreiber.com/tr/'+'">WhatsApp</a>';
document.getElementById("shareLinkedIn").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&url='+'https://www.artikelschreiber.com/tr/'+'">LinkedIn</a>';
document.getElementById("shareEmail").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="mailto:?subject=Check out the free ArtikelSchreiber.com&body='+'https://www.artikelschreiber.com/tr/'+'">eMail</a>';
document.getElementById("sharevKontakte").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://vkontakte.ru/share.php?url='+'https://www.artikelschreiber.com/tr/'+'">vKontakte</a>';
document.getElementById("shareTumblr").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://www.tumblr.com/share/link?url='+'https://www.artikelschreiber.com/tr/'+'">Tumblr</a>';
document.getElementById("shareLineit").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://lineit.line.me/share/ui?url='+'https://www.artikelschreiber.com/tr/'+'">LineIT</a>';
document.getElementById("shareSkype").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://web.skype.com/share?url='+'https://www.artikelschreiber.com/tr/'+'">Skype</a>';
document.getElementById("shareTelegram").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://telegram.me/share/url?url='+'https://www.artikelschreiber.com/tr/'+'">Telegram</a>';
document.getElementById("shareSnapChat").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://snapchat.com/scan?attachmentUrl='+'https://www.artikelschreiber.com/tr/'+'">SnapChat</a>';
document.getElementById("shareReddit").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://reddit.com/submit?url='+'https://www.artikelschreiber.com/tr/'+'">Reddit</a>';
document.getElementById("shareFlipboard").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://share.flipboard.com/bookmarklet/popout?url='+'https://www.artikelschreiber.com/tr/'+'">Flipboard</a>';
document.getElementById("shareXing").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://www.xing.com/spi/shares/new?url='+'https://www.artikelschreiber.com/tr/'+'">XING</a>';
</script>
