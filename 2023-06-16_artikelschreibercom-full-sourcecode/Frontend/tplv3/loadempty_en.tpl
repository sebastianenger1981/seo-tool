...
<html lang="en">
	<head>
		...
		<meta name="keywords" content="write, text generator, article, texts, creative writing, create article, article writer, content creator, content creation, storytelling, free articles, unique text, unique content, article writer, copywriting, copywriter, author, journalism, journalist, editor, editor , Media, newspaper, newspaper article, publication, article writing, text writing, text writing" />
	...
	<body style="text-align: center; overflow-wrap: break-word; word-wrap: normal; word-break: break-word;" translate="yes" lang="en">
		<div class="container">
			<h4 id="showBanner">
				<fieldset lang="en">
					<p>
					Try the service ArtikelSchreiben.com for free: <a href='https://www.artikelschreiben.com/' title='Article writing with ChatGPT AI' hreflang='de' target='_blank'>Article writing with ChatGPT AI</a>
					</p>
					
					<b>Please link to us from professional Websites:</b>
					...
					<p>
						<b><u id="SocialShareButtons">Share text with all your friends:</u></b> &nbsp;&nbsp;&nbsp;
				...
				<fieldset lang="en">
					...
					<p>
						<ul>
							<li>Please keep this web page or tab open - I'll check periodically to see if your article has been completed. </li>
							<li>If so, I'll show it to you, if not, I'll try again a few seconds later. </li>
							<li>Please wait - it will take some time to finish your custom article (it's worth it!!!).</li>
							<li>The service is currently very busy. It may take longer than normal for your item to be completed.</li>
							<li>After your unique article is finished, you can download it as a text file for free or for free.</li>
						</ul>
					</p>
				</fieldset>
			</h4>
			<br />
			<fieldset lang="en">
				<legend><b>Progress in the creation of your article:</b></legend>
			...
			for(i=0; i<=35000; i++) {
				setTimeout(function() { 
					...
					$('.loading span').html(num+'%');
				   	num++;
					if(num>=99){
						$('#statusMessage').html("<br /><br /><br /><b>Perform step 5: Get your article!</b>").show();
					} else if(num>=55){
						$('#statusMessage').html("<br /><br /><br /><b>Perform step 4: Create your individual text!</b>").show();
					} else if(num>=20){
						$('#statusMessage').html("<br /><br /><br /><b>Perform step 3: Use Natural Language Processing Tools to preprocess all found resources!</b>").show();
					} else if(num>=10){
						$('#statusMessage').html("<br /><br /><br /><b>Perform step 2: Creating content sources!</b>").show();
					}else if(num>=1){
						$('#statusMessage').html("<br /><br /><br /><b>Perform step 1: Evaluate your keywords!</b>").show();
					}
				},30000);
			};
		}
...
<script async>
document.getElementById("shareFacebook").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u='+'https://www.artikelschreiber.com/en/'+'">Facebook</a>';
document.getElementById("shareTwitter").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://twitter.com/share?url='+'https://www.artikelschreiber.com/en/'+'">Twitter</a>';
document.getElementById("shareWhatsApp").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="whatsapp://send?text='+'https://www.artikelschreiber.com/en/'+'">WhatsApp</a>';
document.getElementById("shareLinkedIn").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&url='+'https://www.artikelschreiber.com/en/'+'">LinkedIn</a>';
document.getElementById("shareEmail").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="mailto:?subject=Check out the free ArtikelSchreiber.com&body='+'https://www.artikelschreiber.com/en/'+'">eMail</a>';
document.getElementById("sharevKontakte").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://vkontakte.ru/share.php?url='+'https://www.artikelschreiber.com/en/'+'">vKontakte</a>';
document.getElementById("shareTumblr").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://www.tumblr.com/share/link?url='+'https://www.artikelschreiber.com/en/'+'">Tumblr</a>';
document.getElementById("shareLineit").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://lineit.line.me/share/ui?url='+'https://www.artikelschreiber.com/en/'+'">LineIT</a>';
document.getElementById("shareSkype").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://web.skype.com/share?url='+'https://www.artikelschreiber.com/en/'+'">Skype</a>';
document.getElementById("shareTelegram").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://telegram.me/share/url?url='+'https://www.artikelschreiber.com/en/'+'">Telegram</a>';
document.getElementById("shareSnapChat").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://snapchat.com/scan?attachmentUrl='+'https://www.artikelschreiber.com/en/'+'">SnapChat</a>';
document.getElementById("shareReddit").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://reddit.com/submit?url='+'https://www.artikelschreiber.com/en/'+'">Reddit</a>';
document.getElementById("shareFlipboard").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://share.flipboard.com/bookmarklet/popout?url='+'https://www.artikelschreiber.com/en/'+'">Flipboard</a>';
document.getElementById("shareXing").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://www.xing.com/spi/shares/new?url='+'https://www.artikelschreiber.com/en/'+'">XING</a>';
</script>
