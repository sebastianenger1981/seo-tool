...
<html lang="pt">
	<head>
		...
		<meta name="keywords" content="escrever, gerador de texto, artigo, textos, redação criativa, criar artigo, redator de artigo, criador de conteúdo, criação de conteúdo, narrativa, artigos gratuitos, texto exclusivo, conteúdo exclusivo, redator de artigo, redação, redator, autor, jornalismo, jornalista, editor, editor, mídia, jornal, artigo de jornal, publicação, redação de artigo, redação de texto, redação de texto" />
	...
	<body style="text-align:center; overflow-wrap: break-word; word-wrap: normal; word-break: break-word;" translate="yes" lang="pt">
		<div class="container">
			<h4 id="showBanner">
				<fieldset lang="pt">
					...
					<div class="tooltip">
					<button onclick="myFunction();" onmouseout="outFunc()" title="Clique aqui para copiar o texto para a área de transferência!" >
					  <span class="tooltiptext" id="myTooltip">Copiado para a prancheta</span>
					 Copiar texto
					  </button>
					</div>
					
					<p>
						<b><u id="SocialShareButtons">Partilhar texto com amigos:</u></b> &nbsp;&nbsp;&nbsp;
				...
				<br />
				<fieldset lang="pt">
					<legend><b>Informação sobre o estado:</b></legend>
					<p>
						<ul>
							<li>Por favor mantenha esta página web ou separador aberto - verificarei regularmente para ver se o seu artigo foi concluído. </li>
							<li>Se sim, vou mostrá-lo, se não, vou tentar novamente alguns segundos mais tarde. </li>
							<li>Por favor espere - demora um pouco de tempo a terminar o seu artigo individual (vale a pena!!!!).</li>
							<li>O serviço está actualmente muito ocupado. Pode demorar mais tempo do que o normal para que o seu artigo seja completado.</li>
							<li>Depois do seu artigo único ser escrito, pode descarregá-lo como um ficheiro de texto gratuitamente.</li>
						</ul>
					</p>
				</fieldset>
			</h4>
			<br />
			<fieldset lang="pt">
				<legend><b>Progresso na criação do seu artigo:</b></legend>
			...
			for(i=0; i<=35000; i++) {
				setTimeout(function() { 
					...
					$('.loading span').html(num+'%');
				   	num++;
					if(num>=99){
						$('#statusMessage').html("<br /><br /><br /><b>Executar o passo 5: Pegue no seu artigo!</b>").show();
					} else if(num>=55){
						$('#statusMessage').html("<br /><br /><br /><b>Executar a etapa 4: Crie o seu texto individual!</b>").show();
					} else if(num>=20){
						$('#statusMessage').html("<br /><br /><br /><b>Executar a etapa 3: Use ferramentas de processamento de linguagem natural para pré-processar todos os recursos encontrados!</b>").show();
					} else if(num>=10){
						$('#statusMessage').html("<br /><br /><br /><b>Executar a etapa 2: Use fontes de conteúdo!</b>").show();
					}else if(num>=1){
						$('#statusMessage').html("<br /><br /><br /><b>Executar o passo 1: Avalie as suas palavras-chave!</b>").show();
					}
				},30000);
			};
		}
...
function myFunction() {
  ...
  tooltip.innerHTML = "Cópia bem sucedida!";// + copyText.value;
}

function outFunc() {
  var tooltip = document.getElementById("myTooltip");
  tooltip.innerHTML = "Copiado para a prancheta";
}
</script>

<script async>
document.getElementById("shareFacebook").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u='+'https://www.artikelschreiber.com/pt/'+'">Facebook</a>';
document.getElementById("shareTwitter").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://twitter.com/share?url='+'https://www.artikelschreiber.com/pt/'+'">Twitter</a>';
document.getElementById("shareWhatsApp").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="whatsapp://send?text='+'https://www.artikelschreiber.com/pt/'+'">WhatsApp</a>';
document.getElementById("shareLinkedIn").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&url='+'https://www.artikelschreiber.com/pt/'+'">LinkedIn</a>';
document.getElementById("shareEmail").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="mailto:?subject=Check out the free ArtikelSchreiber.com&body='+'https://www.artikelschreiber.com/pt/'+'">eMail</a>';
document.getElementById("sharevKontakte").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://vkontakte.ru/share.php?url='+'https://www.artikelschreiber.com/pt/'+'">vKontakte</a>';
document.getElementById("shareTumblr").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://www.tumblr.com/share/link?url='+'https://www.artikelschreiber.com/pt/'+'">Tumblr</a>';
document.getElementById("shareLineit").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://lineit.line.me/share/ui?url='+'https://www.artikelschreiber.com/pt/'+'">LineIT</a>';
document.getElementById("shareSkype").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://web.skype.com/share?url='+'https://www.artikelschreiber.com/pt/'+'">Skype</a>';
document.getElementById("shareTelegram").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://telegram.me/share/url?url='+'https://www.artikelschreiber.com/pt/'+'">Telegram</a>';
document.getElementById("shareSnapChat").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://snapchat.com/scan?attachmentUrl='+'https://www.artikelschreiber.com/pt/'+'">SnapChat</a>';
document.getElementById("shareReddit").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://reddit.com/submit?url='+'https://www.artikelschreiber.com/pt/'+'">Reddit</a>';
document.getElementById("shareFlipboard").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://share.flipboard.com/bookmarklet/popout?url='+'https://www.artikelschreiber.com/pt/'+'">Flipboard</a>';
document.getElementById("shareXing").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://www.xing.com/spi/shares/new?url='+'https://www.artikelschreiber.com/pt/'+'">XING</a>';
</script>
