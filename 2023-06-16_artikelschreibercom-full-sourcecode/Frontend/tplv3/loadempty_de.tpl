...
<html lang="de">
	<head>
		...
		<meta name="keywords" content="schreiben, Text Generator, artikel, texte, kreatives schreiben, artikel erstellen, artikel schreiber, content creater, content creation, Storytelling, Kostenlose Artikel, Unique Text, Unique Content, artikelschreiber, Copywriting, Copywriter, Autor, Journalismus, Journalist, Redakteur, Redakteurin, Medien, Zeitung, Zeitungsartikel, Veröffentlichung, Artikel schreiben, Text schreiben, Texte schreiben" />
		...
		<link rel="alternate" hreflang="sa" href="https://www.artikelschreiber.com/ar/" />
	...
	<body style="text-align:center; overflow-wrap: break-word; word-wrap: normal; word-break: break-word;" translate="yes" lang="de">
		<div class="container">
			<h4 id="showBanner">
				<fieldset lang="de">
					<p>
					Probiere kostenlos den Service ArtikelSchreiben.com aus: <a href='https://www.artikelschreiben.com/' title='Artikel schreiben mit ChatGPT KI | ArtikelSchreiben.com' hreflang='de' target='_blank'>Artikel schreiben mit ChatGPT KI</a>
					</p>
					
					<b>Bitte verlinke uns auf hochwertigen Webseiten:</b>
					...
					<div class="tooltip">
						<button onclick="myFunction();" onmouseout="outFunc()" title="Klicken Sie hier, um den Text in die Zwischenablage zu kopieren!">
						  <span class="tooltiptext" id="myTooltip">In die Zwischenablage kopiert</span>
						  Text kopieren
						  </button>
					</div>
								
					<p>
						<b><u id="SocialShareButtons">Teile mit all deinen Freunden:</u></b> &nbsp;&nbsp;&nbsp;
				...
				<br />
				<fieldset lang="de">
					<legend><b>Status Information:</b></legend>
					<p>
						<ul>
							<li>Bitte lasse diese Webseite bzw. diesen Tab offen - ich schaue regelmäßig, ob dein Artikel fertiggestellt wurde. </li>
							<li>Wenn ja, zeige ich ihn dir an, wenn nicht, versuche ich es wenige Sekunden später nochmal. </li>
							<li>Bitte warte - es dauert etwas, bis dein individueller Artikel fertiggestellt ist (es lohnt sich!!!).</li>
							<li>Der Service ist aktuell sehr ausgelastet. Es kann länger als normal dauern, bis dein Artikel fertiggestellt ist.</li>
							<li>Nachdem dein einzigartiger Artikel fertiggeschrieben ist, kannst du ihn als Text Datei kostenlos bzw. gratis herunterladen.</li>
						</ul>
					</p>
				</fieldset>
			</h4>
			<br />
			<fieldset lang="de">
				<legend><b>Fortschritt bei der Erstellung deines Artikels:</b></legend>
			...
			for(i=0; i<=35000; i++) {
				setTimeout(function() { 
					...
					$('.loading span').html(num+'%');
				   	num++;
					if(num>=99){
						$('#statusMessage').html("<br /><br /><br /><b>Führe Arbeitsschritt 5 aus: Hole dein Artikel ab!</b>").show();
					} else if(num>=55){
						$('#statusMessage').html("<br /><br /><br /><b>Führe Arbeitsschritt 4 aus: Erstelle deinen individuellen Text!</b>").show();
					} else if(num>=20){
						$('#statusMessage').html("<br /><br /><br /><b>Führe Arbeitsschritt 3 aus: Benutze Natural Language Processing Tools zur Vorverarbeitung alle gefundenen Ressourcen!</b>").show();
					} else if(num>=10){
						$('#statusMessage').html("<br /><br /><br /><b>Führe Arbeitsschritt 2 aus: Verwende Content Quellen!</b>").show();
					}else if(num>=1){
						$('#statusMessage').html("<br /><br /><br /><b>Führe Arbeitsschritt 1 aus: Werte deine Keywords aus!</b>").show();
					}
				},30000);
			};
		}
...
function myFunction() {
  ...
  tooltip.innerHTML = "Erfolgreich kopiert!";
}
...
<script async>
document.getElementById("shareFacebook").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u='+'https://www.artikelschreiber.com/'+'">Facebook</a>';
document.getElementById("shareTwitter").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://twitter.com/share?url='+'https://www.artikelschreiber.com/'+'">Twitter</a>';
document.getElementById("shareWhatsApp").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="whatsapp://send?text='+'https://www.artikelschreiber.com/'+'">WhatsApp</a>';
document.getElementById("shareLinkedIn").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&url='+'https://www.artikelschreiber.com/'+'">LinkedIn</a>';
document.getElementById("shareEmail").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="mailto:?subject=Check out the free ArtikelSchreiber.com&body='+'https://www.artikelschreiber.com/'+'">eMail</a>';
document.getElementById("sharevKontakte").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://vkontakte.ru/share.php?url='+'https://www.artikelschreiber.com/'+'">vKontakte</a>';
document.getElementById("shareTumblr").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://www.tumblr.com/share/link?url='+'https://www.artikelschreiber.com/'+'">Tumblr</a>';
document.getElementById("shareLineit").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://lineit.line.me/share/ui?url='+'https://www.artikelschreiber.com/'+'">LineIT</a>';
document.getElementById("shareSkype").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://web.skype.com/share?url='+'https://www.artikelschreiber.com/'+'">Skype</a>';
document.getElementById("shareTelegram").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://telegram.me/share/url?url='+'https://www.artikelschreiber.com/'+'">Telegram</a>';
document.getElementById("shareSnapChat").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://snapchat.com/scan?attachmentUrl='+'https://www.artikelschreiber.com/'+'">SnapChat</a>';
document.getElementById("shareReddit").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://reddit.com/submit?url='+'https://www.artikelschreiber.com/'+'">Reddit</a>';
document.getElementById("shareFlipboard").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://share.flipboard.com/bookmarklet/popout?url='+'https://www.artikelschreiber.com/'+'">Flipboard</a>';
document.getElementById("shareXing").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://www.xing.com/spi/shares/new?url='+'https://www.artikelschreiber.com/'+'">XING</a>';
</script>
