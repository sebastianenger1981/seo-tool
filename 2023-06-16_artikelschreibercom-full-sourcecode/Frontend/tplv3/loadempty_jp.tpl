...
<html lang="ja">
	<head>
		...
		<meta name="keywords" content="書く、テキストジェネレーター、記事、テキスト、クリエイティブライティング、記事の作成、記事ライター、コンテンツクリエーター、コンテンツ作成、ストーリーテリング、無料記事、ユニークなテキスト、ユニークなコンテンツ、記事ライター、コピーライティング、コピーライター、著者、ジャーナリズム、ジャーナリスト、編集者、編集者、メディア、新聞、新聞記事、出版物、記事執筆、テキスト執筆、テキスト執筆" />
	...
	<body style="text-align:center; overflow-wrap: break-word; word-wrap: normal; word-break: break-word;" translate="yes" lang="ja">
		<div class="container">
			<h4 id="showBanner">
				<fieldset lang="ja">					
					...
					<div class="tooltip">
					<button onclick="myFunction();" onmouseout="outFunc()" title="テキストをクリップボードにコピーするには、ここをクリックしてください。">
					...
					<p>
						<b><u id="SocialShareButtons">友達とテキストを共有する:</u></b> &nbsp;&nbsp;&nbsp;
				...
				<br />
				<fieldset lang="ja">
					<legend><b>ステータス情報:</b></legend>
					<p>
						<ul>
							<li>このウェブサイトまたはこのタブを開いたままにしてください-あなたの記事が完成したかどうかを定期的にチェックします。 </li>
							<li>もしそうなら、私はあなたにそれを見せます、そうでなければ、私は数秒後にもう一度やり直します。</li>
							<li>お待ちください-個々のアイテムが完成するまでしばらく時間がかかります（それだけの価値があります!!!）。</li>
							<li>サービスは現在非常に忙しいです。 記事が完了するまでに通常より時間がかかる場合があります。</li>
							<li>ユニークな記事が書かれた後、あなたはそれを無料または無料でテキストファイルとしてダウンロードすることができます。</li>
						</ul>
					</p>
				</fieldset>
			</h4>
			...
			for(i=0; i<=35000; i++) {
				setTimeout(function() { 
					...
					$('.loading span').html(num+'%');
				   	num++;
					if(num>=99){
						$('#statusMessage').html("<br /><br /><br /><b>作業ステップ5を実行します：あなたのアイテムを手に入れてください！</b>").show();
					} else if(num>=55){
						$('#statusMessage').html("<br /><br /><br /><b>作業ステップ4を実行します：あなたの個々のテキストを作成してください！</b>").show();
					} else if(num>=20){
						$('#statusMessage').html("<br /><br /><br /><b>作業ステップ3を実行します。自然言語処理ツールを使用して、見つかったすべてのリソースを前処理します。</b>").show();
					} else if(num>=10){
						$('#statusMessage').html("<br /><br /><br /><b>作業ステップ2を実行します：コンテンツソースを使用します！</b>").show();
					}else if(num>=1){
						$('#statusMessage').html("<br /><br /><br /><b>作業ステップ1を実行します：キーワードを評価します！</b>").show();
					}
				},30000);
			};
		}
...
function myFunction() {
  ...
  tooltip.innerHTML = "正常にコピーされました!";// + copyText.value;
}
...
<script async>
document.getElementById("shareFacebook").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u='+'https://www.artikelschreiber.com/jp/'+'">Facebook</a>';
document.getElementById("shareTwitter").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://twitter.com/share?url='+'https://www.artikelschreiber.com/jp/'+'">Twitter</a>';
document.getElementById("shareWhatsApp").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="whatsapp://send?text='+'https://www.artikelschreiber.com/jp/'+'">WhatsApp</a>';
document.getElementById("shareLinkedIn").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&url='+'https://www.artikelschreiber.com/jp/'+'">LinkedIn</a>';
document.getElementById("shareEmail").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="mailto:?subject=Check out the free ArtikelSchreiber.com&body='+'https://www.artikelschreiber.com/jp/'+'">eMail</a>';
document.getElementById("sharevKontakte").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://vkontakte.ru/share.php?url='+'https://www.artikelschreiber.com/jp/'+'">vKontakte</a>';
document.getElementById("shareTumblr").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://www.tumblr.com/share/link?url='+'https://www.artikelschreiber.com/jp/'+'">Tumblr</a>';
document.getElementById("shareLineit").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://lineit.line.me/share/ui?url='+'https://www.artikelschreiber.com/jp/'+'">LineIT</a>';
document.getElementById("shareSkype").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://web.skype.com/share?url='+'https://www.artikelschreiber.com/jp/'+'">Skype</a>';
document.getElementById("shareTelegram").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://telegram.me/share/url?url='+'https://www.artikelschreiber.com/jp/'+'">Telegram</a>';
document.getElementById("shareSnapChat").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://snapchat.com/scan?attachmentUrl='+'https://www.artikelschreiber.com/jp/'+'">SnapChat</a>';
document.getElementById("shareReddit").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://reddit.com/submit?url='+'https://www.artikelschreiber.com/jp/'+'">Reddit</a>';
document.getElementById("shareFlipboard").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://share.flipboard.com/bookmarklet/popout?url='+'https://www.artikelschreiber.com/jp/'+'">Flipboard</a>';
document.getElementById("shareXing").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://www.xing.com/spi/shares/new?url='+'https://www.artikelschreiber.com/jp/'+'">XING</a>';
</script>
