...
<html lang="ru">
	<head>
		...
		<meta name="keywords" content="написать, генератор текста, статья, тексты, творческое письмо, создать статью, автор статьи, создатель контента, создание контента, рассказывание историй, бесплатные статьи, уникальный текст, уникальный контент, автор статьи, копирайтинг, копирайтер, автор, журналистика, журналист, редактор, редактор, СМИ, газета, газетная статья, публикация, написание статьи, написание текста, написание текста" />
		...
		<meta property="og:url" content="https://www.artikelschreiber.com/ru/" />
		...
		<meta name="twitter:url" content="https://www.artikelschreiber.com/ru/" />
		...
		<link rel="canonical" href="https://www.artikelschreiber.com/ru/" />
	...
	<body style="text-align:center; overflow-wrap: break-word; word-wrap: normal; word-break: break-word;" translate="yes" lang="ru">
		<div class="container">
			<h4 id="showBanner">
				<fieldset lang="ru">
					...
					<div class="tooltip">
					<button onclick="myFunction();" onmouseout="outFunc()" title="Нажмите здесь, чтобы скопировать текст в буфер обмена!">
					  <span class="tooltiptext" id="myTooltip">Копируется в буфер обмена</span>
					  Копирование текста
					  </button>
					</div>
					
					<p>
						<b><u id="SocialShareButtons">Поделитесь текстом с друзьями:</u></b> &nbsp;&nbsp;&nbsp;
				...
				<br />
				<fieldset lang="ru">
					<legend><b>Информация о состоянии:</b></legend>
					<p>
						<ul>
							<li>Пожалуйста, держите эту веб-страницу или вкладку открытой - я буду регулярно проверять, завершена ли ваша статья. </li>
							<li>Если да, я покажу его вам, если нет, я попробую еще раз через несколько секунд. </li>
							<li>Пожалуйста, подождите - для завершения работы над вашей индивидуальной статьей требуется некоторое время (оно того стоит!!!).</li>
							<li>В настоящее время служба очень загружена. Для выполнения заказа может потребоваться больше времени, чем обычно.</li>
							<li>После того как ваша уникальная статья будет готова, вы сможете бесплатно скачать ее в виде текстового файла.</li>
						</ul>
					</p>
				</fieldset>
			</h4>
			<br />
			<fieldset lang="ru">
				<legend><b>Прогресс в создании вашей статьи:</b></legend>
			...
			for(i=0; i<=35000; i++) {
				setTimeout(function() { 
					...
					$('.loading span').html(num+'%');
				   	num++;
					if(num>=99){
						$('#statusMessage').html("<br /><br /><br /><b>Выполните шаг 5: Заберите свой товар!</b>").show();
					} else if(num>=55){
						$('#statusMessage').html("<br /><br /><br /><b>Выполните шаг 4: Создайте свой индивидуальный текст!</b>").show();
					} else if(num>=20){
						$('#statusMessage').html("<br /><br /><br /><b>Выполните шаг 3: Используйте инструменты обработки естественного языка для предварительной обработки всех найденных ресурсов!</b>").show();
					} else if(num>=10){
						$('#statusMessage').html("<br /><br /><br /><b>Выполните шаг 2: Используйте источники контента!</b>").show();
					}else if(num>=1){
						$('#statusMessage').html("<br /><br /><br /><b>Выполните шаг 1: Оцените свои ключевые слова!</b>").show();
					}
				},30000);
			};
		}
...
function myFunction() {
  ...
  tooltip.innerHTML = "Успешно скопировано!";
}

function outFunc() {
  var tooltip = document.getElementById("myTooltip");
  tooltip.innerHTML = "Копируется в буфер обмена";
}
</script>

<script async>
document.getElementById("shareFacebook").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u='+'https://www.artikelschreiber.com/ru/'+'">Facebook</a>';
document.getElementById("shareTwitter").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://twitter.com/share?url='+'https://www.artikelschreiber.com/ru/'+'">Twitter</a>';
document.getElementById("shareWhatsApp").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="whatsapp://send?text='+'https://www.artikelschreiber.com/ru/'+'">WhatsApp</a>';
document.getElementById("shareLinkedIn").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&url='+'https://www.artikelschreiber.com/ru/'+'">LinkedIn</a>';
document.getElementById("shareEmail").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="mailto:?subject=Check out the free ArtikelSchreiber.com&body='+'https://www.artikelschreiber.com/ru/'+'">eMail</a>';
document.getElementById("sharevKontakte").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://vkontakte.ru/share.php?url='+'https://www.artikelschreiber.com/ru/'+'">vKontakte</a>';
document.getElementById("shareTumblr").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://www.tumblr.com/share/link?url='+'https://www.artikelschreiber.com/ru/'+'">Tumblr</a>';
document.getElementById("shareLineit").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://lineit.line.me/share/ui?url='+'https://www.artikelschreiber.com/ru/'+'">LineIT</a>';
document.getElementById("shareSkype").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://web.skype.com/share?url='+'https://www.artikelschreiber.com/ru/'+'">Skype</a>';
document.getElementById("shareTelegram").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://telegram.me/share/url?url='+'https://www.artikelschreiber.com/ru/'+'">Telegram</a>';
document.getElementById("shareSnapChat").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://snapchat.com/scan?attachmentUrl='+'https://www.artikelschreiber.com/ru/'+'">SnapChat</a>';
document.getElementById("shareReddit").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="http://reddit.com/submit?url='+'https://www.artikelschreiber.com/ru/'+'">Reddit</a>';
document.getElementById("shareFlipboard").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://share.flipboard.com/bookmarklet/popout?url='+'https://www.artikelschreiber.com/ru/'+'">Flipboard</a>';
document.getElementById("shareXing").innerHTML = '<a rel="noopener noreferrer nofollow" target="_blank" href="https://www.xing.com/spi/shares/new?url='+'https://www.artikelschreiber.com/ru/'+'">XING</a>';
</script>
