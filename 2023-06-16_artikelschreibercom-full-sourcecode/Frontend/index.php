...
//error_reporting(E_ALL);
//ini_set('display_errors', 1);
header("Link: </js/jquery.ddslick.min.js>; rel=preload; as=script", false);
header("Link: </js/jquery.min.js>; rel=preload; as=script", false);
header("Link: </images/facebook.png>; rel=preload; as=image", false);
header("Link: </images/flags/de.png>; rel=preload; as=image", false);
header("Link: </images/flags/en.png>; rel=preload; as=image", false);
*/
/*
...
header('Link: <https://www.artikelschreiber.com/>; rel="canonical"');
header("Pragma: cache");
...
$content 			= array_merge(
		...
		array('index_title_short_de'=>$language_array[$language]['index_title_short']),
		array('index_description_de'=>$language_array[$language]['index_description']),
		array('index_title_short_en'=>$language_array["en"]['index_title_short']),
		array('index_description_en'=>$language_array["en"]['index_description']),
		array('startpage_url_de'=>$language_array[$language]['url']),
		array('startpage_url_en'=>$language_array["en"]['url']),
		...
		array('article_text_singleline'=>"✓ Kostenlose Texte ✓ Unique Content ✓ Marketing Texte ✓ Unique Text | ArtikelSchreiber.com"),
		array('count_articles'=>"Das Team vom <b>Artikel Schreiber</b> hat bereits für $p_count_articles zufriedene Benutzer kostenlosen <strong>SEO Content</strong> erstellt. Mit 3 Klicks bist auch du dabei!"),
		array('topics'=>"")
	);
$Minify 	= new Minify();
$design		= new Template();
$design->setPath("/home/www/wwwartikelschreiber/tplv3");
$HtmlOutputDesign 	= $design->display_cache('index', $content, false, false, 3600*3);
